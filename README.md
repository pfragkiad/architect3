...
Τα βέλτιστα σενάρια που παράγονται συνοψίζονται στον παρακάτω πίνακα. Με πλάγια γραφή η τιμή που επιλέχθηκε στην προηγούμενη εργασία (εφόσον είναι διαφορετική) με βάση τη συνάρτηση κόστους:
...
| speclibm  | 64/*32*         | 16/*32*                | 16                 | 1             | 1              | 2             | 512          |
| specmcf   | 64/*32*         | 16/*32*               | 32                 | 1             | 1              | 2             | 512          |
| specsjeng | 64 /*32*        | 32                | 16                 | 1             | 1              | 2             | 512          |

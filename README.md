...
Τα βέλτιστα σενάρια που παράγονται συνοψίζονται στον παρακάτω πίνακα. *Με πλάγια γραφή η τιμή που επιλέχθηκε στην προηγούμενη εργασία (εφόσον είναι διαφορετική) με βάση τη συνάρτηση κόστους που είχε σχηματιστεί*:

| Benchmark | Cache line | L1 Data Size [kB] | L1 Instr Size [kB] | L1 Data Assoc | L1 Instr Assoc | L2 Data Assoc | L2 Size [kB] |
|-----------|------------|-------------------|--------------------|---------------|----------------|---------------|--------------|
| specbzip  | 64         | 32/*16*           | 16                 | 1             | 1              | 2             | 512          |
| spechmmer | 64         | 16                | 16                 | 1             | 1              | 2             | 512          |
| speclibm  | 64         | 16                | 16                 | 1             | 1              | 2             | 512          |
| specmcf   | 64/*32*    | 16/*32*           | 32                 | 1             | 1              | 2             | 512          |
| specsjeng | 64/*32*    | 32                | 16/*32*            | 1             | 1              | 2             | 512          |

Παρατηρούμε ότι **στον μεγαλύτερο αριθμό των παραμέτρων προέκυψαν οι ίδιες τιμές** γεγονός που δείχνει ότι επιβεβαιώνει σε κάποιο βαθμό την αξιοπιστία της συνάρτησης κόστους.

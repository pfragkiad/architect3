...
Παρατηρούμε ότι **στον μεγαλύτερο αριθμό των παραμέτρων προέκυψαν οι ίδιες τιμές** γεγονός που δείχνει ότι επιβεβαιώνεται σε κάποιο βαθμό η αξιοπιστία της συνάρτησης κόστους.
